...
def stim_config(ifi):
    ...
    # Stimuli parameters
    stim['size_CUE'] = 0.9 # degs # este es el lado del cuadrado del grating/ gaussian blob
    stim['radius'] = 11
...
def monitor_def():
    ...
    monitor_def2['monitor_height'] = 30
    ...
    monitor_def3['monitor_height'] = 35
    monitor_def3['distance2monitor'] = 60
